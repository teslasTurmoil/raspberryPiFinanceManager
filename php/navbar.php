...
<html>
    <head>
        <title><?php if (empty($pageTitle)){ echo "Finance Manager";} else { echo $pageTitle; } ?></title>
        <meta charset="UTF-8">
        ...
        <header>
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="#">Savings Funds <span class="toggle">Expand</span><span class="caret"></span></a>
                        <nav>
                            <ul>
                                <li><a href="editFunds.php">Edit Funds</a></li>
                                <li><a href="viewFunds.php">View Funds</a></li>
                                <li><a href="fundPayment.php">Transfer Fund(s)</a></li>
                            </ul>
                        </nav>
                    </li>
                    ...
                    <li><a href='#'>Tools <span class="toggle">Expand</span><span class="caret"></span></a>
                        <nav>
                            <ul>
                                <li><a href="importCSV.php">Import CSV File</a></li>
                                <li><a href="importQFX.php">Import QFX File</a></li>
                            </ul>
                        </nav>
                    </li>
                </ul>
